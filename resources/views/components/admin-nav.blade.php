<nav class="bg-secondary py-1 px-6 hidden sm:block shadow-md">
    <ul class="flex sm:space-x-7 lg:justify-center">
        ...
        <li class="{{ Request::is('internal/doors/create') ? 'border-primary' : 'border-transparent' }} border-b-2 hover:border-primary transition ease-out duration-500"><a href="/internal/doors/create" class="text-white uppercase text-sm">Upload Door</a></li>
